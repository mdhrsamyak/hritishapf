            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2 text-[12px] sm:text-[16px] lg:text-[16px] font-extralight">
                <span>
                  ...
                  disabled individuals in extreme sports.
                </span>
                <span>
                  2. Drive engagement by sharing personal stories, inspiring
                  feats, and milestones, showcasing his achievements and
                  challenges along the way.
                </span>
                <span>
                  3. Promote brand partnerships and sponsor visibility by
                  highlighting Hari's collaborations with brands and his ongoing
                  work to inspire the disabled community.
                </span>
              </div>
            </div>
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2 text-[12px] sm:text-[16px] font-extralight">
                ...
                <span>
                  2. Influencer & Brand Partnerships - Collaborated with
                  value-aligned brands and influencers to amplify reach. Hosted
                  live Q&A sessions and sponsor-led integrations (e.g.,
        ...
        <div className="flex flex-col mt-20 gap-15">
          ...
          <div className="flex flex-col gap-7 text-[18px] lg:text-[20px]">
            ...
            <div className="flex flex-col text-[12px] sm:text-[16px] font-extralight gap-5">
              ...
              <span>
                • Achieved 84.6K video views, 56.8K reach, and 1.4K+
                interactions on key content pieces, strengthening community
                engagement.
              </span>
              <span>
                • Consistently positioned Hari as a global voice for resilience
                and inclusivity, leading to increased sponsorship visibility and
